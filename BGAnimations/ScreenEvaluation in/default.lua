return Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		LoadActor("cleared glow")..{
			InitCommand=cmd(CenterX;y,SCREEN_CENTER_Y+130;cropleft,-0.3;cropright,1;faderight,.1;fadeleft,.1;);
			OnCommand=cmd(sleep,0.35;linear,0.7;cropleft,1;cropright,-0.3);
		};
		LoadActor("cleared text")..{ InitCommand=cmd(); };
	};
	Def.ActorFrame{
		Name="Failed";
		BeginCommand=function(self)
		...
		LoadActor("failed text")..{ InitCommand=cmd(); };
	};
};
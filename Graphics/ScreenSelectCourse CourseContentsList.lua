return Def.CourseContentsList {
	...
	SetCommand=function(self)
		...
		self:PositionItems();
		self:SetTransformFromHeight(37);
	...
	Display = Def.ActorFrame { 
		...
		LoadFont("Common Normal") .. {
			...
			SetSongCommand=function(self, params)
				...
				(cmd(finishtweening;zoomy,0;sleep,0.125*params.Number;linear,0.125;zoomy,1;linear,0.05;zoomx,1;decelerate,0.1;zoom,1))(self);
			end;
		};
